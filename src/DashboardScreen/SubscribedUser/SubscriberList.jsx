...
import { Delete, Get, GetList, GetName } from '../../Config/ApiHandling'
...
const SubscriberList = () => {
            ...
            displayFeild: (item) => (
                <>
                    <div style={{ display: "flex", justifyContent: "center" }}>
                        ...
                        <DeleteButton text="Delete" click={() => DeleteSubscriber(item._id)} />
                    </div>
                </>
            ),
        },
    ...
    const GetData = () => {
        GetList(`getSubscribedUser`, token)
            .then((res) => {
    ...
    let edit = (item) => {
        navigation("/dashboard/EditSubscriber", {
            state: item
        });
    }
    ...
    return (
        <>
            <div>
                <MainHeader />
                <Header screenTitle="Subscriber List" />
                <ToastContainer />
                <Box>
                    <AddButton path="/dashboard/EditSubscriber" />
                </Box>
                <>
                    <div style={{ display: 'flex', justifyContent: 'center' }}>
                        {data ? (
