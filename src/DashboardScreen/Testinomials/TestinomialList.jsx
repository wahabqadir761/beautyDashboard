...
const TestimonialList = () => {
    ...
    let edit = (item) => {
        navigation("/dashboard/EditTestinomial", {
            state: item
        });
    }
        ...
        Swal.fire({
            ...
            ?.then((result) => {
                if (result.isConfirmed) {
                    Delete("deletetestimonails", e, token)
                        ?.then((res) => {
                            GetData()
                        })
                        .catch((e) => {
    ...
    return (
        <>
            <div>
                <MainHeader />
                <Header screenTitle="Testinomial List" />
                <ToastContainer />
                <Box>
                    <AddButton path="/dashboard/EditTestinomial" />
                </Box>
                <>
                                                        ...
                                                        {x.displayFeild ? (
                                                            ...
                                                            (x.key === 'amount' || x.key === 'price') ? `$${item[x.key]}` :
                                                                x.key === "name" ? item?.name :
                                                                    x.key === "rating" ? item?.rating :
                                                                        x.key === "comment" ? item?.comment :
